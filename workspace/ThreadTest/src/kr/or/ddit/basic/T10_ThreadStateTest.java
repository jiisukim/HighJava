 ...
 * 	- WAITING, TIMED_WAITING : 스레드의 작업이 종료되지는 않았지만 실행가능하지 않은 일시정지 상태(UNRUNNABLE).
 * 							   TIMED_WAITING 은 일시정지 시간이 지정된 경우임
...
class StatePrintThread extends Thread{
	...
	public StatePrintThread(Thread targetThreat) {
		this.targetThread = targetThreat;
	}
	@Override
	public void run() {
		while(true) {
