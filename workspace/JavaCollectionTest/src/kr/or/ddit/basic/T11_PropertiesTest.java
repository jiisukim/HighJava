 ...
 * Map은 모든 형태의 객체 데이터를 key와 value값으로 사용할 수 있지만, Properties는 key와 value값으로 String 만 사용할 수 있다.
 * 
 ...
 */
	public static void main(String[] args) throws IOException {
		...
		//내용을 파일로 저장하기
		prop.store(new FileOutputStream("./src/kr/or/ddit/basic/properties"),"코멘트입니다.");
	}
}
